...
These seeds are only used to prepare the source tables for the Jaffle tutorials (hence the separate project)  
Cf [My tutorial](https://github.com/mgn-dbt/tutorial)
...
So use another editor to work on your develop_duck git branch.
